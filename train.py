...
def make_unity_env():
	...
	#attempt another worker
	try:
		unity_env = UnityEnvironment(file_name=os.path.join(currpath,"envs/Crawlerv2/Crawler.x86_64"), side_channels=[channel], worker_id=1)
	except:
		print("Worker ID 1 already running. Attempting ID 2")
